...
3- Perform a "custom" FizzBuzz with input beginning and ending numbers, as well as replaced words instead of "Fizz" and "Buzz" these are taken from a split user input
